...
![Turns](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/turns.png?raw=true)
...
![Degree of turns](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/turn_degrees.png?raw=true)

![Turn degrees](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/degree_of_turns.png?raw=true)
...
![Simultaneous action bow](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/simultaneous_action_bow.png?raw=true)
...
![Turn levels](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/turn_levels.png?raw=true)
...
![Change in turn levels](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/levels_turns.png?raw=true)
...
![Continuous turn](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/continuous_turns.png?raw=true)
...
![Interwoven turns](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/interwoven_turns.png?raw=true)
...
![Action lines](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/action_lines.png?raw=true)
...
![Front sign](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/front_sign.png?raw=true)
...
![Established Front](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/established_front.png?raw=true)
...
![Constant cross of axes](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/cross_of_axes.png?raw=true)

### Front signs and their use
Here are all eight front signs:

![Front directions](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/front_directions.png?raw=true)
...
![Changing fronts](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/changing_fronts.png?raw=true)
...
![Turns with faces](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/turns_with_faces.png?raw=true)

## Focal Point
The directions can be specified with respect to a focal point as well. The focal point could be an apparatus, the performer's partner, center of the group and so on. Focal point is indicated by ![Focal point](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/focal_point.png?raw=true)

At the start of the score, the focal point for the dancer should be specified as follows:

![focal point specification](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/focal_point_spe.png?raw=true)
...
![focal point with turns](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/focal_point_turns.png?raw=true)
...
![focal point with meeting line](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/meeting_line.png?raw=true)

**Space hold symbol:** ![space hold](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/space_hold.png?raw=true)
...
### A few more symbols
1. Angular release sign - Cancel the space hold sign. ![angular release](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/angular_Release.png?raw=true)
2. Ad libitum (Optional degree of turn) - Amount of turning is not fixed - the performer has freedom to choose. ![ad libitum](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/ad_libitum.png?raw=true)
3. Infinity - Perform as many turns as possible. ![infinity](https://github.com/rusimody/Laban-tk/blob/pucsd_laban_project/docs/img/infinity.png?raw=true)
